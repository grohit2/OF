package com.hT.historicalload.repository.impl;

import com.hT.historicalload.HistoricalLoadAppProperties;
import com.hT.historicalload.models.*;
...
public class TransactionStoreRepositoryImpl implements TransactionStoreRepository {
    ...
    public TransactionStoreProcessingContext putItem(
        ...
        // skip putting to dynamoDB if processing status is already set
        ...
        final Transaction transaction = transactionStoreProcessingContext.transaction();
        ...
        try {
            ...
            final PutItemRequest putItemRequest = PutItemRequest.builder()
                ...
                .item(createAttributesValueMap(transaction))
            ...
            return TransactionStoreProcessingContextBuilder.builder(transactionStoreProcessingContext)
                ...
                // if conditional check fails, we need to get previous transaction store request
                .previousTransactionStoreRequest(toTransactionRequest(conditionalCheckFailedException))
                .build();
        } catch (final Exception e) {
            final String errorMessage = String.format(
                "Error putting item in transaction store: AccountPartition: %s, OrderKey: %s - " +
                "ErrorMessage: %s",
    ...
    private HashMap<String, AttributeValue> createAttributesValueMap(final Transaction transaction) {
        ...
        itemValues.put(
            ...
            transaction.event() != null
                ? AttributeValue.builder()
                    .b(SdkBytes.fromString(transaction.event(), Charset.defaultCharset()))
                    .build()
            ...
            return Optional.of(TransactionBuilder.builder()
                ...
                .event(
                    attributes.get("event") != null
                        ? attributes.get("event").b().asUtf8String()
                        : null)
                .financialCoreCommandId(
